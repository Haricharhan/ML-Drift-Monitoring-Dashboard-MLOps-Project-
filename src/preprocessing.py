...
def dynamic_preprocessor(churn_df, target_col):   # ✅ accept DataFrame
    ...
    # Binary encoding
    binary_cols = [col for col in categorical_cols if inputs[col].nunique() == 2]
    ...
    # One-hot encoding
    multiple_cols = [col for col in categorical_cols if inputs[col].nunique() > 2]
